...
```powershell
ffmpeg -hide_banner -loglevel error -f lavfi -i 'sine=frequency=440:sample_rate=44100:duration=3' -af 'volume=0.2,afade=t=in:d=0.1,afade=t=out:st=2.5:d=0.5' -ac 2 -c:a libmp3lame -b:a 128k -metadata title='MeowKit - quiet test tone' -n test-tone-44100.mp3
```
